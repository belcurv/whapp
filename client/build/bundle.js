...
*/
var formatSkills = function formatSkills(profiles) {
    var skillsMap = mapSkillCounts(profiles);
    var formattedArr = makeFormattedSkillsArr(skillsMap);
...
exports.$on = $on;
exports.formatSkills = formatSkills;
